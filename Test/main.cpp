...
int main()
{
    ...
    Reflection::ReflectionInstance type = Reflection::TypeMeta::newFromNameAndJson("Vector3", Json::object{});

    Vector3* v = static_cast<Vector3*>(type.m_instance);

    auto json = Serializer::Write(v);
    cout << json.dump() << endl;

    Reflection::ReflectionPtr ptr2("Vector3", v);

    REFLECTION_DELETE(ptr2);
